...
Use `requirements/_template.md` for new detailed requirement files.

Use `reports/` for one-off audit findings, compatibility matrices, design comparisons, and implementation reports. Reports can inform requirements or backlog changes, but they are not the source of accepted scope.
